...
class clock:
    ...
    def draw_second(self):
        self.draw_hand(pose[self.second], self.len_second, self.color_second) 
    def draw_minute(self):
        self.draw_hand(pose[self.minute], self.len_minute, self.color_minute) 
    def draw_hour(self):
        self.draw_hand(pose[self.hour], self.len_hour, self.color_hour) 
